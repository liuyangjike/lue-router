...
// 解析路径, current是一个routeRecord的数组, next也是一个RouteRecord数组
// 对比两个数组差别, 找到开始不一样的位置i, 那么0到i都是一样的, 就是updated;
// 对于next, 从i到最后为它独有的, 为activated
// 对于current, 从i1到最后为它独有的, 为deactivated
